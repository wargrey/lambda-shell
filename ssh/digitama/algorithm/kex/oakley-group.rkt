...
(struct dh-modp-group
  ([id : Byte]            #;[group id]
   [p : Positive-Integer] #;[2^n - 2^(n-64) - 1 + 2^64 * (⌊2^(n-130)π⌋ + i)]
   [g : Byte]             #;[generator]
...
(define-modp-dh-group dh2048
  #:group 14 #:magic 124476
  #:generator 2
  [#:prime
   FFFFFFFF   FFFFFFFF   C90FDAA2 2168C234 C4C6628B   80DC1CD1
   |29024E08| 8A67CC74   020BBEA6 3B139B22 514A0879   8E3404DD
...
(define-modp-dh-group dh3702
  #:group 15 #:magic 1690314 #:generator 2
  [#:prime
   FFFFFFFF   FFFFFFFF   C90FDAA2 2168C234 C4C6628B   80DC1CD1
   |29024E08| 8A67CC74   020BBEA6 3B139B22 514A0879   8E3404DD
   EF9519B3   CD3A431B   302B0A6D F25F1437 4FE1356D   6D51C245
...
(define-modp-dh-group dh4096
  #:group 16 #:magic 240904 #:generator 2
  [#:prime
   FFFFFFFF   FFFFFFFF   C90FDAA2 2168C234 C4C6628B   80DC1CD1
   |29024E08| 8A67CC74   020BBEA6 3B139B22 514A0879   8E3404DD
   EF9519B3   CD3A431B   302B0A6D F25F1437 4FE1356D   6D51C245
...
(define-modp-dh-group dh6144
  #:group 17 #:magic 929484 #:generator 2
  [#:prime
...
(define-modp-dh-group dh8192
  #:group 18 #:magic 4743158 #:generator 2
  [#:prime
   FFFFFFFF   FFFFFFFF   C90FDAA2   2168C234 C4C6628B   80DC1CD1
   |29024E08| 8A67CC74   020BBEA6   3B139B22 514A0879   8E3404DD
   EF9519B3   CD3A431B   302B0A6D   F25F1437 4FE1356D   6D51C245
