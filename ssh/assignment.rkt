...
(define-ssh-messages
  ...
  [SSH_MSG_KEXINIT                   20 ([cookie : (SSH-Bytes 16) (ssh-cookie)]
                                         [kex : (Listof Symbol) ssh-kex-method-list]
                                         [publickey : (Listof Symbol) ssh-publickey-format-list]
                                         [local-cipher : (Listof Symbol) ssh-cipher-list]
                                         [remote-cipher : (Listof Symbol) ssh-cipher-list]
                                         [local-mac : (Listof Symbol) ssh-mac-algorithm-list]
                                         [remote-mac : (Listof Symbol) ssh-mac-algorithm-list]
                                         [local-compression : (Listof Symbol) ssh-compression-method-list]
                                         [remote-compression : (Listof Symbol) ssh-compression-method-list]
